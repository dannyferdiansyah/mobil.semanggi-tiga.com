                ...
                <tbody>
                  <?php foreach ($peminjaman->result() as $mobil) {
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url() ?>img/<?php echo $mobil->foto_berangkat ?>" target="_blank"><img src="<?php echo base_url() ?>img/<?php echo $mobil->foto_berangkat ?>" width="70" height="80"></a><br><?php echo number_format((float)$mobil->km_berangkat) ?> KM</td>
                      <td><a href="<?php echo base_url() ?>img/<?php echo $mobil->foto_pulang ?>" target="_blank"><img src="<?php echo base_url() ?>img/<?php echo $mobil->foto_pulang ?>" width="70" height="80"></a><br><?php echo number_format((float)$mobil->km_pulang) ?> KM</td>
